  ...
  return (
    <Container >
      ...
      <Row style={{height: "200px"}} className="mt-4">
        <div className="d-flex gap-2 mx-auto" style={{height: "100%", width: "100%"}}>
          <Button href="https://t.me/RareFnd" variant="warning" size="lg" style={{width: "50%", fontSize: "40px", fontWeight: "bold", textAlign: "center", verticalAlign: "middle", lineHeight: "200px"}}>
            Work better, together
          </Button>
          <Button href="https://t.me/RareFnd" variant="light" size="lg" style={{width: "50%", fontSize: "40px", fontWeight: "bold", textAlign: "center", verticalAlign: "middle", lineHeight: "200px"}}>
