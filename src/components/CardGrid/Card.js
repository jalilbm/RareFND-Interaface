                ...
                <Row>
                  <Col className={"mt-2 " + (props.image ? "" : "text-center")}>
                    <Link to={props.buttonHref}>
                      <Button className="rise-button" style={{fontFamily:"'Poppins', sans-serif",lineHeight: "1.6",fontSize: "1rem"}} variant="warning" size="lg">
                        {props.buttonText}
                        <i class="fa fa-arrow-right" style={{padding: "12px 13px"}}></i>
                      </Button>
                    </Link>
                  </Col>
                </Row>
